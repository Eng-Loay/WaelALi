...
import { fetchStudentAssignment, fetchStudentAssignments } from '../../api/studentApi';
      ...
      {selected && (
        <div className="student-detail-card">
          ...
          <div className="student-detail-links">
            {selected.image_url && <a href={selected.image_url} target="_blank" rel="noreferrer">صورة الواجب</a>}
            {selected.file_url && <a href={selected.file_url} target="_blank" rel="noreferrer">PDF الواجب ({fileLinkLabel(selected.file_url)})</a>}
          </div>
